...
class PdoGsb
{
    ...
    public function majFraisHorsForfait($idVisiteur, $mois, $montant,$idFrais,$libelle,$date)
    {
            ...
            $requetePrepare->bindParam(':uneDate', $dateHF, PDO::PARAM_STR);
            $requetePrepare->execute();
    ...
    public function getLesVisiteurs(){
            ...
            . 'visiteur.prenom AS prenom, visiteur.id AS id FROM visiteur '
